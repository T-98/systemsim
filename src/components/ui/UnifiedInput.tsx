        ...
        >
          ...
          <div className="flex items-center justify-between mt-2">
            <button
              ...
              title="Attach a Miro, Figma, or Excalidraw screenshot"
              className="inline-flex items-center gap-1.5 rounded-lg transition-colors disabled:opacity-30"
              style={{
                padding: '6px 10px',
                color: 'var(--accent)',
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.background = 'var(--accent-ring)';
              }}
            >
              ...
              <span style={{ fontSize: 12, fontWeight: 500, letterSpacing: '-0.12px' }}>
                Attach image
              </span>
            </button>
